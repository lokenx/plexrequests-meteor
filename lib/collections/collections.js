 ...
 */
   ...
   */
    ...
    tautulliNotifierID: {
        type: Number,
        label: 'Tautulli Notification Agent ID',
        defaultValue: 1,
        optional: true
    },
    tautulliURL: {
        type: String,
        label: 'Tautulli Server URL',
        defaultValue: 'https://plexpy.example.com',
        optional: true
    },
    tautulliPORT: {
        type: Number,
        label: 'Tautulli Server Port',
        defaultValue: 443,
        optional: true
    },
    tautulliSSL: {
        type: Boolean,
        label: 'Use SSL for Tautulli',
        defaultValue: false,
        optional: true
    },
    tautulliENABLED: {
