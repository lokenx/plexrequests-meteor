Meteor.methods({
    ...
    setTestVARS: function (t, b, request) {
        ...
        message_title = message_title.replace(tags.m_type, req.media_type)
        message_title = message_title.replace(tags.user, req.user)
        message_title = message_title.replace(tags.issues, req.issues)
        message_title = message_title.replace(tags.year, req.year)
        ...
        message_body = message_body.replace(tags.year, req.year)
